...
def median_cut(imgs, num_colors, unique=False):
...
list=['input/avatar.jpg']
#list=['input/mountain.jpg']
imgs=[]
merged=Image.new('RGB', (256, 256),(255,255,255))
for item in list:
    my_image = Image.open(item)
    imgs+=[my_image]
...
median_non_unique = median_cut(imgs, 8)
# median_unique = median_cut(imgs, 8, unique=True)
...
# show_median_cut(median_non_unique)
merged.show()
